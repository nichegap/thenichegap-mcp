...
server.tool("analyze_niche_gap", "Analyze an SEO keyword to find search intent, industry must-haves, and content gaps using real SERP data from TheNicheGap. Use this to help craft highly differentiated articles.", {
    ...
    try {
        const response = await axios.post("https://thenichegap.com/api/analyze", {
            keyword,
            locale: locale || "en",
        }, {
            headers: {
